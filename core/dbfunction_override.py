...
class DBFunctionOverride:
    ...
    def run_test(self):
        ...
        try:
            ...
            raise Exception("Database error while deleting test function: %s" % e)  # pylint: disable=broad-except
    ...
    def create_exploit_function(self):
        ...
        try:
            ...
            raise Exception("Database error while creating exploit function: %s" % e)  # pylint: disable=broad-except
